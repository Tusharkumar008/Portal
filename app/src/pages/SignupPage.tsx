...
import { Eye, EyeOff, Mail, Lock, User, Briefcase, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#F6F7F9] flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-72 h-72 bg-[#F05A44]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-[#0B1A3A]/5 rounded-full blur-3xl" />
      </div>
      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              ...
              <Label htmlFor="terms" className="text-sm text-gray-600 cursor-pointer leading-relaxed">
                I agree to the{' '}
                <Link to="#" className="text-[#F05A44] hover:underline">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="#" className="text-[#F05A44] hover:underline">
          ...
          >
            ...
            <Link to="/login" className="text-[#F05A44] hover:underline font-medium">
              Sign in
            </Link>
          </motion.p>
        </motion.div>
